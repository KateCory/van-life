...
class {
  ...
  v(t, e, n, r, s) {
    ...
    const u = {};
    return this.I(u, r, s), this.T(t, o, u, n).then((e2) => (y("RestConnection", `Received RPC '${t}' ${i}: `, e2), e2), (e2) => {
  ...
  static fromBase64String(t) {
    const e = function(t2) {
      try {
        ...
        throw "undefined" != typeof DOMException && t3 instanceof DOMException ? new Vt("Invalid base64 string: " + t3) : t3;
      }
    }(t);
    return new $t(e);
  }
...
var Xt = class extends Jt {
  ...
  matches(t) {
    ...
    return "!=" === this.op ? null !== e && this.matchesComparison(jt(e, this.value)) : null !== e && Mt(this.value) === Mt(e) && this.matchesComparison(jt(e, this.value));
  }
  matchesComparison(t) {
    switch (this.op) {
      case "<":
...
var te = class extends Jt {
  ...
  getFlattenedFilters() {
    return null !== this.F || (this.F = this.filters.reduce((t, e) => t.concat(e.getFlattenedFilters()), [])), this.F;
  }
  ...
  getFirstInequalityField() {
    const t = this.S((t2) => t2.isInequality());
...
function ee(t, e) {
  return t instanceof Xt ? function(t2, e2) {
    return e2 instanceof Xt && t2.op === e2.op && t2.field.isEqual(e2.field) && Lt(t2.value, e2.value);
...
function Pe(t) {
  ...
  if (null === e.O) {
    ...
    if (null !== t2 && null === n)
      t2.isKeyField() || e.O.push(new he(t2)), e.O.push(new he(
        nt.keyField(),
        "asc"
        /* Direction.ASCENDING */
      ));
      ...
      if (!t3) {
        ...
        e.O.push(new he(nt.keyField(), t4));
      }
    }
  }
  return e.O;
...
function Ve(t) {
  ...
  if (!e.k)
    if ("F" === e.limitType)
      e.k = Ee(e.path, e.collectionGroup, Pe(e), e.filters, e.limit, e.startAt, e.endAt);
    else {
      const t2 = [];
      ...
      e.k = Ee(e.path, e.collectionGroup, t2, e.filters, e.limit, n, r);
    }
  return e.k;
}
function $e(t, e) {
...
function un(t, e) {
  ...
  const o = function(t2, e2) {
    return t2.useProto3Json || ft(e2) ? e2 : {
      value: e2
    };
  }(t, e.limit);
  var u;
...
var pn = class {
  ...
  Y(t) {
    ...
    r > 0 && y("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.B} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), this.W = this.M.enqueueAfterDelay(this.timerId, r, () => (this.G = Date.now(), t())), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
async function gn(t, e) {
  const n = A(t), r = nn(n.serializer) + "/documents", s = {
    writes: e.map((t2) => on(n.serializer, t2))
  };
...
var Yn = class {
  ...
  ct(t) {
    return mr(t, this.settings.methodName, this.settings.at || false, this.path, this.settings.ht);
  }
...
function Jn(t, e, n, r, s, i = {}) {
  const o = t.lt(i.merge || i.mergeFields ? 2 : 0, e, n, s);
...
var nr = class extends Bn {
  ...
  _toFieldTransform(t) {
    const e = tr(
      ...
      /*array=*/
      true
    ), n = this.ft.map((t2) => cr(t2, e)), r = new Se(n);
...
var rr = class extends Bn {
  ...
  _toFieldTransform(t) {
    const e = tr(
      ...
      /*array=*/
      true
    ), n = this.ft.map((t2) => cr(t2, e)), r = new qe(n);
    return new ke(t.path, r);
  }
  isEqual(t) {
    return this === t;
...
function or(t, e, n, r, s, i) {
  const o = t.lt(1, e, n), u = [fr(e, r, n)], c = [s];
  if (i.length % 2 != 0)
...
function cr(t, e) {
  ...
  return function(t2, e2) {
    ...
    if (t2 instanceof Date) {
      ...
      return {
        timestampValue: Ke(e2.serializer, n)
      };
    }
    if (t2 instanceof St) {
    ...
    if (t2 instanceof Ln)
      return {
        bytesValue: Ye(e2.serializer, t2._byteString)
      };
    if (t2 instanceof Fn) {
...
var gs = class {
  constructor(t, e, n, r, s) {
    this.asyncQueue = t, this.datastore = e, this.options = n, this.updateFunction = r, this.deferred = s, this.wt = n.maxAttempts, this.yt = new pn(
      this.asyncQueue,
      "transaction_retry"
  ...
  vt(t) {
    this.wt > 0 && this.bt(t) ? (this.wt -= 1, this.asyncQueue.enqueueAndForget(() => (this.gt(), Promise.resolve()))) : this.deferred.reject(t);
  }
  bt(t) {
...
var bs = class {
  constructor() {
    this.Et = Promise.resolve(), // A list of retryable operations. Retryable operations are run in order and
    // retried with backoff.
    this.At = [], // Is this AsyncQueue being shut down? Once it is set to true, it will not
    // be changed again.
    this.It = false, // Operations scheduled to be queued in the future. Operations are
    // automatically removed after they are run or canceled.
    this.Tt = [], // visible for testing
    this.Rt = null, // Flag set while there's an outstanding AsyncQueue operation, used for
    // assertion sanity-checks.
    this.Pt = false, // Enabled during shutdown on Safari to prevent future access to IndexedDB.
    this.Vt = false, // List of TimerIds to fast-forward delays for.
    this.$t = [], // Backoff timer used to schedule retries for retryable operations
    this.yt = new pn(
      this,
      "async_queue_retry"
    ...
    this.Dt = () => {
      const t2 = _s();
      t2 && y("AsyncQueue", "Visibility state changed to " + t2.visibilityState), this.yt.Z();
    };
    const t = _s();
  ...
  enqueue(t) {
    ...
    const e = new j();
    return this.Ft(() => this.It && this.Vt ? Promise.resolve() : (t().then(e.resolve, e.reject), e.promise)).then(() => e.promise);
  }
  enqueueRetryable(t) {
  ...
  async xt() {
    if (0 !== this.At.length) {
      ...
      this.At.length > 0 && // If there are additional operations, we re-schedule `retryNextOp()`.
  ...
  Ft(t) {
    const e = this.Et.then(() => (this.Pt = true, t().catch((t2) => {
      this.Rt = t2, this.Pt = false;
      const e2 = (
        /**
  ...
  kt(t) {
    return this.qt().then(() => {
      this.Tt.sort((t2, e) => t2.targetTimeMs - e.targetTimeMs);
      for (const e of this.Tt)
